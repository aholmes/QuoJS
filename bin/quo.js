...
(function() {
  (function($$) {
    ...
    $$.fn.each = $$.each = function(elements, callback) {
      var i, key;
      i = void 0;
      key = void 0;
      if ($$.toType(elements) === "array") {
...
(function() {
  (function($$) {
    ...
    HOLD_DELAY = 650;
    GESTURES = ["touch", "tap", "singleTap", "doubleTap", "hold", "swipe", "swiping", "swipingLeft", "swipingRight", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "rotate", "rotating", "rotateLeft", "rotateRight", "pinch", "pinching", "pinchIn", "pinchOut", "drag", "dragLeft", "dragRight", "dragUp", "dragDown"];
    ...
    _onTouchMove = function(event) {
      var fingers, is_swipe, swipe_direction, touches;
      EVENT = event;
      if (GESTURE.el) {
        touches = _getTouches(event);
        fingers = touches.length;
